...
Begin VB.Form frmOptions 
   ...
   Begin VB.Frame frmOpt 
      ...
      Begin VB.CheckBox chkCExit 
         ...
         Width           =   3615
      End
      Begin VB.CheckBox chkOUS 
         Caption         =   "One Upload Slot Per User"
         Height          =   255
         Left            =   120
         TabIndex        =   36
         Top             =   480
         Width           =   3615
      End
      Begin VB.CheckBox chkSCD 
         Caption         =   "Share Completed Downloads"
         Height          =   255
         Left            =   120
         TabIndex        =   35
         Top             =   240
   ...
   Begin VB.Frame frmOpt 
      ...
      Begin VB.ComboBox cmbVersion 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "frmOptions.frx":12948
         Left            =   1320
         List            =   "frmOptions.frx":12952
         Style           =   2  'Dropdown List
         TabIndex        =   32
         Top             =   1680
         Width           =   3855
      ...
      Begin VB.ComboBox cmbSpeed 
         Height          =   315
         ItemData        =   "frmOptions.frx":12968
         Left            =   1320
         List            =   "frmOptions.frx":1298D
         Style           =   2  'Dropdown List
         TabIndex        =   22
         Top             =   1320
         Width           =   3855
...
Randomize
    ...
    cboSpeed.ListIndex = GetSetting("INap", "Options", "MaxSpeed", "5")
    chkGator.Value = GetSetting("INap", "Options", "GetGator", "1")
    chkCExit.Value = GetSetting("INap", "Options", "CExit", "1")
    chkSCD.Value = GetSetting("INap", "Options", "SCD", "1")
    chkOUS.Value = GetSetting("INap", "Options", "OUS", "1")
...
Me.Hide
    ...
    SaveSetting "INap", "Options", "MaxSpeed", cboSpeed.ListIndex
    SaveSetting "INap", "Options", "OUS", chkOUS.Value
    SaveSetting "INap", "Options", "SCD", chkSCD.Value
    SaveSetting "INap", "Options", "GetGator", chkGator.Value
    SaveSetting "INap", "Options", "CExit", chkCExit.Value
...
frmShare.lblShare.Caption = "Geting Server List!!"
    ...
    If chkCExit.Value = vbChecked Then CExit = True
    If chkOUS.Value = vbChecked Then OUS = True
    If chkSCD.Value = vbChecked Then SCD = True
